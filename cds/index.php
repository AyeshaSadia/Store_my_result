...
<main>
    <div  style="width: %100px;">
        <center><h1 class="py-4 bg-dark text-light rounded"><i class="fas fa-graduation-cap"></i>Store My Result</h1></center><h4 style="text-align: right;"><b><a href="logout.php";>Logout</a></b></h4>
